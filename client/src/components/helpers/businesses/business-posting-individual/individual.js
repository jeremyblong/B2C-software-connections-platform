                                ...
                                <div class="single-page-header-inner">
                                    <div class="left-side">
                                        ...
                                        <div class="header-details">
                                            <h3 className="text-white">Restaurant General Manager</h3>
                                            <h5 className="text-white">About the Employer</h5>
                                            <ul>
                                                <li><a style={{ color: "tan" }}><i class="icon-material-outline-business"></i> King</a></li>
                                                <li><div class="star-rating" data-rating="4.9"></div></li>
                                                <li style={{ color: "tan" }}><img class="flag" src="/images/flags/gb.svg" alt="" /> United Kingdom</li>
...
export default BusinessPostingsIndividual;