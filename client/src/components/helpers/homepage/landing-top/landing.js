                    ...
                    <div className="row">
                                <div className="col-md-12">
                                    <div className="banner-headline">
                                        <h3>
                                            <strong className="text-white"><strong style={{ color: "#F26A8D" }}>Hire experts</strong> or be hired for <strong style={{ color: "#F26A8D" }}>any</strong> job, any time.</strong>
                                            <br/>
                                            <span className="text-white">Thousands of small businesses use <strong style={{ color: "#F26A8D" }}>Hireo</strong> to turn their ideas into reality.</span>
                                        </h3>
                                    </div>
                                </div>
                            </div>
