                ...
                <div style={{ borderTop: "3px solid lightgrey" }}>
                    <div class="dashboard-container">
                        ...
                        <div class="dashboard-content-container" data-simplebar>
                            ...
                            <div style={{ marginTop: "70px" }} class="headline">
                                <h3><i class="icon-feather-folder-plus"></i>Location Selection</h3>
                            </div>
                            ...
                            <div class="dashboard-content-inner">
                                ...
                                <div className="row mx-auto">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-4">
                                            <div className="submit-field">
                                                <h5>Apt, Suite, Building, etc... (If Applicable)</h5>
                                                <input onChange={(e) => {
                                                    this.setState({
                                                        housingExtension: e.target.value
                                                    })
                                                }} value={this.state.housingExtension} type="text" className="with-border" placeholder={"Example - Apt 405..."} />
                                            </div>
                                        </div>
...
export default withRouter(connect(mapStateToProps, { completedSignup })(LocationFreelancerSignupHelper));