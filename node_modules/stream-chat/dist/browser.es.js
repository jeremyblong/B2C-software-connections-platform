...
var ChannelState = /*#__PURE__*/function () {
  ...
  _createClass(ChannelState, [{
    ...
    value: function addMessagesSorted(newMessages) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (initializing && _message.id && this.threads[_message.id]) {
            // If we are initializing the state of channel (e.g., in case of connection recovery),
            // then in that case we remove thread related to this message from threads object.
            // This way we can ensure that we don't have any stale data in thread object
            // and consumer can refetch the replies.
            this.threads = this.threads.without(_message.id);
          }
          ...
          if (this.last_message_at && parsedMsg.created_at.getTime() > this.last_message_at.getTime()) {
            this.last_message_at = new Date(parsedMsg.created_at.getTime());
          }
      ...
      var messages = Immutable.asMutable(this.messages);
      ...
      for (var _i2 = 0, _updatedThreads = updatedThreads; _i2 < _updatedThreads.length; _i2++) {
        ...
        var _threadMessages = this.threads[_parentID] ? Immutable.asMutable(this.threads[_parentID]) : [];
    ...
    value: function addReaction(reaction, message) {
      ...
      if (parent_id && this.threads[parent_id]) {
        ...
        for (var i = 0; i < thread.length; i++) {
          ...
          var messageWithReaction = this._addReactionToMessage(msg, reaction);
      ...
      if (!show_in_channel && !parent_id || show_in_channel) {
        for (var _i3 = 0; _i3 < messages.length; _i3++) {
          var _msg = messages[_i3];

          var _messageWithReaction = this._addReactionToMessage(_msg, reaction);
          ...
          this.messages = messages.set(_i3, _messageWithReaction);
          break;
        }
      }
    }
    ...
    value: function _addReactionToMessage(message, reaction) {
      ...
      var newMessage = this._removeReactionFromMessage(message, reaction);
    ...
    value: function _removeReactionFromMessage(message, reaction) {
      var filterReaction = function filterReaction(old) {
        return old.filter(function (item) {
          var _item$user, _reaction$user2;

          return item.type !== reaction.type || ((_item$user = item.user) === null || _item$user === void 0 ? void 0 : _item$user.id) !== ((_reaction$user2 = reaction.user) === null || _reaction$user2 === void 0 ? void 0 : _reaction$user2.id);
        });
      };
    ...
    value: function removeReaction(reaction, message) {
      ...
      if (!show_in_channel && !parent_id || show_in_channel) {
        for (var _i4 = 0; _i4 < messages.length; _i4++) {
          ...
          this.messages = messages.set(_i4, _messageWithReaction2);
          break;
        }
      }
    }
...
var Channel = /*#__PURE__*/function () {
  ...
  _createClass(Channel, [{
    ...
    key: "enableSlowMode",
    value: function () {
      var _enableSlowMode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(coolDownInterval) {
        var data;
    ...
    key: "disableSlowMode",
    value: function () {
      var _disableSlowMode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9() {
        var data;
    ...
    key: "truncate",
    value: function () {
      var _truncate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11() {
    ...
    key: "acceptInvite",
    value: function () {
      var _acceptInvite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12() {
        var options,
            data,
            _args12 = arguments;
    ...
    key: "rejectInvite",
    value: function () {
      var _rejectInvite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13() {
        var options,
            data,
            _args13 = arguments;
    ...
    key: "addMembers",
    value: function () {
      var _addMembers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(members, message) {
        var data;
    ...
    key: "addModerators",
    value: function () {
      var _addModerators = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(members, message) {
        var data;
    ...
    key: "inviteMembers",
    value: function () {
      var _inviteMembers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(members, message) {
        var data;
    ...
    key: "removeMembers",
    value: function () {
      var _removeMembers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee17(members, message) {
        var data;
    ...
    value: function () {
      var _demoteModerators = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee18(members, message) {
        var data;
    ...
    key: "mute",
    value: function () {
      var _mute = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee19() {
        var opts,
            _args19 = arguments;
    ...
    key: "unmute",
    value: function () {
      var _unmute = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee20() {
        var opts,
            _args20 = arguments;
    ...
    key: "keystroke",
    value: function () {
      var _keystroke = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee21() {
        var _this$getConfig, _this$lastTypingEvent;
        ...
        return _regeneratorRuntime.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 2:
                now = new Date();
                diff = this.lastTypingEvent && now.getTime() - ((_this$lastTypingEvent = this.lastTypingEvent) === null || _this$lastTypingEvent === void 0 ? void 0 : _this$lastTypingEvent.getTime());
    ...
    key: "stopTyping",
    value: function () {
      var _stopTyping = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee22() {
    ...
    key: "markRead",
    value: function () {
      var _markRead = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee23() {
    ...
    key: "watch",
    value: function () {
      var _watch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee24(options) {
    ...
    key: "stopWatching",
    value: function () {
      var _stopWatching = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee25() {
        var response;
    ...
    key: "getReplies",
    value: function () {
      var _getReplies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee26(parent_id, options) {
        var data;
    ...
    value: function countUnread(lastRead) {
      ...
      var _iterator = _createForOfIteratorHelper$1(this.state.messages.asMutable()),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var m = _step.value;
          var message = m.asMutable({
            deep: true
          });

          if (this.getClient().userID === ((_message$user = message.user) === null || _message$user === void 0 ? void 0 : _message$user.id)) {
            continue;
          }
    ...
    value: function countUnreadMentions() {
      ...
      var _iterator2 = _createForOfIteratorHelper$1(this.state.messages.asMutable()),
          _step2;
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (this.getClient().userID === ((_message$user2 = message.user) === null || _message$user2 === void 0 ? void 0 : _message$user2.id)) {
            continue;
          }
          ...
          if (m.created_at > lastRead) {
            (function () {
              var _m$mentioned_users;

              var userID = _this2.getClient().userID;

              if (((_m$mentioned_users = m.mentioned_users) === null || _m$mentioned_users === void 0 ? void 0 : _m$mentioned_users.findIndex(function (u) {
                return u.id === userID;
              })) !== -1) {
                count++;
              }
     ...
     */
    value: function () {
      var _query = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee27(options) {
        var queryURL, state;
    ...
    key: "banUser",
    value: function () {
      var _banUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee28(targetUserID, options) {
    ...
    key: "hide",
    value: function () {
      var _hide = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee29() {
        var userId,
            clearHistory,
            _args29 = arguments;
        return _regeneratorRuntime.wrap(function _callee29$(_context29) {
          while (1) {
            switch (_context29.prev = _context29.next) {
              case 0:
                userId = _args29.length > 0 && _args29[0] !== undefined ? _args29[0] : null;
                clearHistory = _args29.length > 1 && _args29[1] !== undefined ? _args29[1] : false;
    ...
    key: "show",
    value: function () {
      var _show = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee30() {
        var userId,
            _args30 = arguments;
    ...
    key: "unbanUser",
    value: function () {
      var _unbanUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee31(targetUserID) {
    ...
    value: function _handleChannelEvent(event) {
      var _event$user, _event$user2, _event$user3, _event$user4, _event$user5, _event$member, _event$user6;
      ...
      switch (event.type) {
        ...
        case 'user.updated':
          if ((_event$user4 = event.user) === null || _event$user4 === void 0 ? void 0 : _event$user4.id) {
    ...
    value: function _initializeState(state) {
      ...
      if (state.read) {
        var _iterator5 = _createForOfIteratorHelper$1(state.read),
            _step5;

        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var read = _step5.value;
      ...
      if (state.members) {
        var _iterator6 = _createForOfIteratorHelper$1(state.members),
            _step6;
...
function isReadableStream(obj) {
  return obj !== null && _typeof(obj) === 'object' && // @ts-expect-error
  typeof obj._read === 'function' && // @ts-expect-error
  _typeof(obj._readableState) === 'object';
}
...
var StreamChat = /*#__PURE__*/function () {
  function StreamChat(key, secretOrOptions, _options) {
    ...
    if (this.node) {
      ...
      this.options = _objectSpread$4(_objectSpread$4(_objectSpread$4({}, nodeOptions), defaultOptions), inputOptions);
    } else {
      this.options = _objectSpread$4(_objectSpread$4({}, defaultOptions), inputOptions);
  ...
  _createClass(StreamChat, [{
    ...
    */
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return this.post(this.baseURL + '/check_push', _objectSpread$4(_objectSpread$4(_objectSpread$4(_objectSpread$4({
                  user_id: userID
                }, data.messageID ? {
    ...
    value: function disconnect(timeout) {
      ...
      for (var _i2 = 0, _Object$values = Object.values(this.activeChannels); _i2 < _Object$values.length; _i2++) {
        var channel = _Object$values[_i2];
    ...
    */
    ...
    key: "queryUsers",
    value: function () {
      var _queryUsers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(filterConditions) {
        var sort,
            options,
            sortFields,
            _i4,
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                for (_i4 = 0, _Object$entries = Object.entries(sort); _i4 < _Object$entries.length; _i4++) {
                  _Object$entries$_i = _slicedToArray(_Object$entries[_i4], 2), k = _Object$entries$_i[0], v = _Object$entries$_i[1];
                  sortFields.push({
                    field: k,
                    direction: v
                  });
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                for (_i5 = 0, _Object$entries2 = Object.entries(sort); _i5 < _Object$entries2.length; _i5++) {
                  _Object$entries2$_i = _slicedToArray(_Object$entries2[_i5], 2), k = _Object$entries2$_i[0], v = _Object$entries2$_i[1];
                  sortFields.push({
                    field: k,
                    direction: v
                  });
    ...
    key: "addDevice",
    value: function () {
      var _addDevice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(id, push_provider, userID) {
        return _regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
    ...
    key: "removeDevice",
    value: function () {
      var _removeDevice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(id, userID) {
        return _regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
    ...
    key: "muteUser",
    value: function () {
      var _muteUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee24(targetID, userID) {
        var options,
            _args24 = arguments;
        return _regeneratorRuntime.wrap(function _callee24$(_context24) {
          while (1) {
    ...
    key: "unmuteUser",
    value: function () {
      var _unmuteUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee25(targetID, currentUserID) {
        return _regeneratorRuntime.wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              case 0:
    ...
    key: "flagMessage",
    value: function () {
      var _flagMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee26(targetMessageID) {
        var options,
            _args26 = arguments;
        return _regeneratorRuntime.wrap(function _callee26$(_context26) {
          while (1) {
    ...
    value: function () {
      ...
      function translateMessage(_x41, _x42) {
    ...
    value: function () {
      ...
      function updateMessage(_x43, _x44) {
    ...
    value: function () {
      ...
      function deleteMessage(_x45, _x46) {
    ...
    value: function getUserAgent() {
      return this.userAgent || "stream-chat-javascript-client-".concat(this.node ? 'node' : 'browser', "-", "2.3.1");
    }
  }, {
    key: "setUserAgent",
    ...
    value: function _startCleaning() {
      ...
      this.cleaningIntervalRef = setInterval(function () {
        ...
        for (var _i6 = 0, _Object$values2 = Object.values(that.activeChannels); _i6 < _Object$values2.length; _i6++) {
          var channel = _Object$values2[_i6];
          channel.clean();
        }
      }, 500);
    }
...
export { Allow, AllowAll, AnyResource, AnyRole, BuiltinPermissions, BuiltinRoles, Channel, ChannelState, CheckSignature, ClientState, Deny, DenyAll, DevToken, EVENT_MAP, JWTServerToken, JWTUserToken, MaxPriority, MinPriority, Permission, StableWSConnection, StreamChat, TokenManager, UserFromToken, chatCodes, decodeBase64, encodeBase64, isValidEventType, logChatPromiseExecution };
