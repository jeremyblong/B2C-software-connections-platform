...
import { APIResponse, AppSettings, AppSettingsAPIResponse, BanUserOptions, ChannelAPIResponse, ChannelData, ChannelFilters, ChannelMute, ChannelOptions, ChannelSort, CheckPushResponse, Configs, ConnectAPIResponse, CreateChannelOptions, CreateChannelResponse, CreateCommandOptions, CreateCommandResponse, CustomPermissionOptions, DeleteCommandResponse, Device, Event, EventHandler, FlagMessageOptions, FlagMessageResponse, FlagUserResponse, GetChannelTypeResponse, GetCommandResponse, ListChannelResponse, ListCommandsResponse, LiteralStringForUnion, Logger, MarkAllReadOptions, Message, MessageFilters, MessageResponse, MuteUserOptions, MuteUserResponse, PartialUserUpdate, PermissionAPIResponse, PermissionsAPIResponse, ReactionResponse, SearchAPIResponse, SearchOptions, SendFileAPIResponse, StreamChatOptions, TestPushDataInput, TokenOrProvider, UnBanUserOptions, UnknownType, UpdateChannelOptions, UpdateChannelResponse, UpdateCommandOptions, UpdateCommandResponse, UpdateMessageAPIResponse, UserFilters, UserOptions, UserResponse, UserSort } from './types';
export declare class StreamChat<AttachmentType extends UnknownType = UnknownType, ChannelType extends UnknownType = UnknownType, CommandType extends string = LiteralStringForUnion, EventType extends UnknownType = UnknownType, MessageType extends UnknownType = UnknownType, ReactionType extends UnknownType = UnknownType, UserType extends UnknownType = UnknownType> {
     ...
     */
    setUser: (user: UserResponse<UserType>, userTokenOrProvider: TokenOrProvider) => ConnectAPIResponse<ChannelType, CommandType, UserType>;
    ...
    sendFile(url: string, uri: string | NodeJS.ReadableStream | File, name?: string, contentType?: string, user?: UserResponse<UserType>): Promise<SendFileAPIResponse>;
    ...
    queryChannels(filterConditions: ChannelFilters<ChannelType, CommandType, UserType>, sort?: ChannelSort, options?: ChannelOptions): Promise<Channel<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>[]>;
    /**
     ...
     */
    channel(channelType: string, channelID: string, custom?: ChannelData<ChannelType>): Channel<AttachmentType, ChannelType, CommandType, EventType, MessageType, ReactionType, UserType>;
    /**
    ...
    flagUser(userID: string, options?: FlagMessageOptions<UserType>): Promise<FlagUserResponse<UserType>>;
    unflagMessage(messageID: string, options?: FlagMessageOptions<UserType>): Promise<FlagMessageResponse<UserType>>;
    unflagUser(userID: string, options?: FlagMessageOptions<UserType>): Promise<FlagUserResponse<UserType>>;
    /**
     ...
     */
    updateMessage(message: Message<AttachmentType, MessageType, UserType>, userId?: string | {
        id: string;
