...
export declare type CommandResponse<CommandType extends string = LiteralStringForUnion> = {
    args?: string;
    description?: string;
...
export declare type UserResponse<T = UnknownType> = User<T> & {
    banned?: boolean;
    created_at?: string;
...
export declare type FlagMessageOptions<UserType = UnknownType> = {
    client_id?: string;
    connection_id?: string;
    created_by?: string;
    target_message_id?: string;
 ...
 * Sort Types
 */
export declare type ChannelSort<ChannelType = UnknownType> = Sort<ChannelType> & {
    created_at?: AscDesc;
    has_unread?: AscDesc;
...
export declare type UserSort<UserType = UnknownType> = Sort<UserResponse<UserType>>;
/**
 * Base Types
 */
...
export declare type Message<AttachmentType = UnknownType, MessageType = UnknownType, UserType = UnknownType> = MessageBase<AttachmentType, MessageType, UserType> & {
...
export declare type User<T = UnknownType> = T & {
    id: string;
    anon?: boolean;
    name?: string;
    role?: string;
